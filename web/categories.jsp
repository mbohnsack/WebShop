...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div id="content" class="content">
      ...
      if (produktCat.equals("Mikrofone")) {
      ResultSet rs = db.getProductsByKategorie("Mikrofone");
      %>
      <div class="prod_box">
      ...
      <% } }%>
      <%
      if (produktCat.equals("Lautsprecher")) {
      ResultSet rs = db.getProductsByKategorie("Lautsprecher");
      %>
      <div class="prod_box">
        <div class="top_prod_box"></div>
        <div class="center_prod_box">
