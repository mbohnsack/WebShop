...
<div class="prod_box">
    ...
    <div class="center_prod_box">
        <form id="details" action="details.jsp" mathod="post"><button style="margin:0; background:none; border:0; cursor:pointer;" name="details" type="submit" value="<%= rs.getString(1) %>"><div class="product_title"><%= rs.getString(3) %> <%= rs.getString(7) %> (<%= db2.getAnzahlBuchungById(rs.getInt(1)) %>)</div></button></form>
