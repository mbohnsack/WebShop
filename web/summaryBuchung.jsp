...
<script>
    window.fbAsyncInit = function () {
        FB.init({
            appId: '971763672885631', status: true, cookie: true,
            xfbml: true
        });
    };
    (function () {
            ...
            <div class="center_content">
                ...
                <div class="prod_box_big">
                    ...
                    <div class="center_prod_box_big">
                        ...
                        <div><strong style="font-size: 110%">Ihre Buchung ist mit folgenden Daten bei uns
                            eingegangen:</strong></div>


                        <br>

                        <p style="font-size: 110%">Buchungs Code: ${buchCode}</p><br/>
                        <%
                        ...
                        <table style="width: 90%" align="center">
                            <tr>
                                ...
                                <td style="font-size: 110%">Abhol-Datum: <%= buchungsDaten.getString(2)%>
                                </td>
                                <td style="font-size: 110%">Abgabe-Datum: <%= buchungsDaten.getString(3)%>
                                </td>
                                <td style="font-size: 110%">Buchungs-Status: <%= buchungsDaten.getString(5)%>
                                </td>
                        ...
                        <%
                            ...
                            // Produktliste nochmal aus dem Cart holen und anzeigen
                        ...
                        <table style="width: 75%" style="background-color: #a6847d" align="center">
                            ...
                            <%
                                ...
                                //ab dem zweiten Tag gibt es 40% Rabatt
